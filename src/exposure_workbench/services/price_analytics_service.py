...
# V23: the price statistics are METHODS of the skill registry
# (analytics/skill.py, price.*), executed by compute; the tool specs that
# lived here — nine tools for seven statistics and two reads — are gone with
# the tools. The observation floors above are the producer parameters the
# registry's fails_when sentences name.
